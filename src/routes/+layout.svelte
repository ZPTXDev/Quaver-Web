...
{#if $navigating || $manualLoading}
	<div transition:fade="{{ duration: 250 }}" class="fixed top-0 left-0 right-0 bottom-0 z-50 w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-gray-200 dark:bg-gray-900">
